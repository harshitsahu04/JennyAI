...
div.stButton > button:first-child {background:linear-gradient(135deg,#FFD700,#0A2342); color:#FFD700; border-radius:12px; font-weight:700; font-size:16px; padding:14px 32px; box-shadow:0 4px 14px rgba(0,0,0,0.1); display:block; margin:0 auto; margin-top:20px; transition: all 0.3s ease;}
